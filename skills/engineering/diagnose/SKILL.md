...
**Then ask: what would have prevented this bug?** If the answer involves architectural change, flag it. Make the recommendation **after** the fix is in, not before — you have more information now than when you started.
