...
Dependencies that have local test stand-ins (in-memory database, in-memory filesystem). Deepenable if the stand-in exists. The seam is internal; no port at the module's external interface.
